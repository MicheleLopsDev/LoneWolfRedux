...
Text[7]=["Bonus Disciplines","You gain one (1) additional Discipline, and a bonus of +1(CS) and +2(EP) (This bonus is permanent and should be added to your Base score) for each New Order adventure you have previously completed. Each Discipline also becomes stronger as you advance through the Ranks as a Grand Master. So the more adventures you finish the stronger you become."]
...
Text[9]=["Grand Weaponmastery","When you learn the skill of Grand Weaponmastery you may check one (1) weapon from the list below. You may also check one (1) weapon for each previous New Order adventure you have completed. <br /> <br /> If you enter combat holding a weapon that you have selcted you gain a +5(CS) bonus. If you select the Bow, add three (3) to any Random Number you pick while using the Bow."]
...
Text[18]=["Kai Name","In the New Order series you are no longer playing as Lone Wolf and must select a Kai Name for your character.<br /><br /> You may select a name on your own or use the chart found in the game rules to generate a name."]
Text[19]=["Kai Weapon","Your Kai Weapon is a strong magical weapon given to you by Lone Wolf. You may generate or select a Kia Weapon from the chart found in the game rules.<br /><br /> PLEASE READ THE GAME RULES CARFULLY! <br /><br /> Your Kai Weapon is a Special Item and it can be carried and used in addition to two normal weapons. If you possess the Discipline of Grand Weaponmastery for a weapon type which is the same as your unique Kai Weapon, you may add the Grand Weaponmastery bonus of +5 to your COMBAT SKILL. This is in addition to the bonus gained when you use your Kai Weapon in combat."]
